...
Dictation Mode does not participate in stacks, although Instruction Mode may include a Text Insertion operation when the text is explicit or resolved from Reusable Text Memory. Spoken undo is a Shortcut Invocation of the current Input Environment undo action.
